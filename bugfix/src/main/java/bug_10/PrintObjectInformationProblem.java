...
public class PrintObjectInformationProblem {
    ...
    public static void main(String[] args) {
        //Company company = new Company("Name1", "Address1");
        System.out.println(new User(new Company("Name1", "Address1"),"Ivan", "Ivanov", 18));
    }
...
class User {
    ...
    public User(Company company, String name, String surName, int age) {
